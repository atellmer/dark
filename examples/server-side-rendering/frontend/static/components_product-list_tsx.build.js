"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["components_product-list_tsx"],{
...
/* harmony import */ var _dark_engine_web_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @dark-engine/web-router */ "../../../packages/web-router/src/use-location/use-location.ts");
/* harmony import */ var _dark_engine_web_router__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @dark-engine/web-router */ "../../../packages/web-router/src/router-link/router-link.tsx");
/* harmony import */ var _dark_engine_styled__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @dark-engine/styled */ "../../../packages/styled/src/styled/styled.ts");
...
const Header = _dark_engine_styled__WEBPACK_IMPORTED_MODULE_2__.styled.header `
  display: grid;
...
`;
const ProductList = (0,_dark_engine_core__WEBPACK_IMPORTED_MODULE_3__.component)(({ slot }) => {
    const { url } = (0,_dark_engine_web_router__WEBPACK_IMPORTED_MODULE_4__.useMatch)();
    const { pathname } = (0,_dark_engine_web_router__WEBPACK_IMPORTED_MODULE_5__.useLocation)();
    const { data, loading, error } = (0,_hooks__WEBPACK_IMPORTED_MODULE_0__.useProducts)();
    const isList = pathname.endsWith('list/');
    const urlToAdd = url + 'add/';
    const renderList = () => {
        return ((0,_dark_engine_core__WEBPACK_IMPORTED_MODULE_6__.h)(_ui__WEBPACK_IMPORTED_MODULE_1__.List, null, [...data].reverse().map(x => {
            return ((0,_dark_engine_core__WEBPACK_IMPORTED_MODULE_6__.h)(_ui__WEBPACK_IMPORTED_MODULE_1__.ListItem, { key: x.id },
                (0,_dark_engine_core__WEBPACK_IMPORTED_MODULE_6__.h)(_dark_engine_web_router__WEBPACK_IMPORTED_MODULE_7__.RouterLink, { to: `${url}${x.id}` }, x.name)));
        })));
    };
    if (loading)
        return (0,_dark_engine_core__WEBPACK_IMPORTED_MODULE_6__.h)(_ui__WEBPACK_IMPORTED_MODULE_1__.Spinner, null);
    if (error)
        return (0,_dark_engine_core__WEBPACK_IMPORTED_MODULE_6__.h)(_ui__WEBPACK_IMPORTED_MODULE_1__.Error, { value: error });
    return ((0,_dark_engine_core__WEBPACK_IMPORTED_MODULE_6__.h)(_ui__WEBPACK_IMPORTED_MODULE_1__.AnimationFade, null,
        (0,_dark_engine_core__WEBPACK_IMPORTED_MODULE_6__.h)(Header, null,
            (0,_dark_engine_core__WEBPACK_IMPORTED_MODULE_6__.h)("div", null, isList ? ((0,_dark_engine_core__WEBPACK_IMPORTED_MODULE_6__.h)(_ui__WEBPACK_IMPORTED_MODULE_1__.Button, { as: _dark_engine_web_router__WEBPACK_IMPORTED_MODULE_7__.RouterLink, to: urlToAdd }, "Add product")) : ((0,_dark_engine_core__WEBPACK_IMPORTED_MODULE_6__.h)(_ui__WEBPACK_IMPORTED_MODULE_1__.Button, { onClick: () => history.back() }, "Back")))),
        (0,_dark_engine_core__WEBPACK_IMPORTED_MODULE_6__.h)(_ui__WEBPACK_IMPORTED_MODULE_1__.AnimationFade, { key: pathname }, slot || renderList())));
});
...
//# sourceMappingURL=components_product-list_tsx.build.js.map